...
First let us open our Python interactive shell. Go to your you computer terminal and write 'python'. 
The python interactive shell will be opened.
'''
...
>>>'''
# In the example above, I added an extra s to math deliberately and _ModuleNotFoundError_ was raised. 
...
[Clang 11.0.0 (clang-1100.0.33.8)] on darwin
Type "help", "copyright", "credits" or "license" for more information.
>>> users = {'name':'Ajay', 'age':250, 'country':'India'}
>>> users['name']
'Ajay'
>>> users['county']
Traceback (most recent call last):
...
[Clang 11.0.0 (clang-1100.0.33.8)] on darwin
Type "help", "copyright", "credits" or "license" for more information.
>>> user = {'name':'Ajay', 'age':250, 'country':'India'}
>>> user['name']
'Ajay'
>>> user['county']
Traceback (most recent call last):
...
# Another solution would be converting the number to a string (the result then would be '43'). Let us follow the first fix.
