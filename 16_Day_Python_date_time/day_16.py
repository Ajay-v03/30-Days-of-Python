...
As you can see, in the datetime module there are many functions, but we will focus on _date_, _datetime_, _time_ and _timedelta_. 
Let se see them one by one.
'''
### Getting *datetime* Information

from datetime import datetime
now = datetime.now()
print(now)                      # 2022-08-16 07:34:46.549883
day = now.day                   # 16
month = now.month               # 8
year = now.year                 # 2022
hour = now.hour                 # 7
...
print(f'{day}/{month}/{year}, {hour}:{minute}')  # 16/8/2022, 7:38
