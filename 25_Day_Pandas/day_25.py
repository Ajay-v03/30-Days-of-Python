## Pandas
'''
Pandas is an open source, high-performance, easy-to-use data structures and data analysis tools for the  programming language.
...
# In order to create a pandas series we should use numpy to create a one dimensional arrays or a  list.
...
dct = {'name':'Ajay','country':'India','city':'Hisar'}
...
data = {'Name': ['Ajay', 'David', 'John'], 'Country':[
    'India', 'UK', 'Sweden'], 'City': ['Hisar', 'London', 'Stockholm']}
...
data = [
    {'Name': 'Ajay', 'Country': 'India', 'City': 'Hisar'},
...
# Therefore, we should use a method to know the colums.  we do not know the number of rows. 
# Let's use shape meathod.
