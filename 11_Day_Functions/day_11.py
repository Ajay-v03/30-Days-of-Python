...
To define or declare a function, Python provides the _def_ keyword. The following is the syntax for defining a function.
...
# - Single Parameter: If our function takes a parameter we should call our function with an argument
  # Declaring a function
def function_name(parameter):pass
...
'''- Two Parameter: A function may or may not have a parameter or parameters.
 A function may also have two or more parameters. If our function takes parameters we should call it with arguments. 
...
def generate_full_name (first_name, last_name):
    ...
    full_name = first_name + space + last_name
    return full_name
print('Full Name: ', generate_full_name('Ajay','Verma'))
...
def print_fullname(firstname, lastname):
    ...
    print(full_name)
print(print_fullname(firstname = 'Ajay', lastname = 'Verma'))
...
'''If we do not return a value with a function, then our function is returning _None_ by default. 
To return a value with a function we use the keyword _return_ followed by the variable we are returning.
We can return any kind of data types from a function.
'''
# - Returning a string:
def print_name(firstname):
    return firstname
print_name('Ajay') # Ajay

def print_full_name(firstname, lastname):
    space = ' '
    full_name = firstname  + space + lastname
    return full_name
print_full_name(firstname='Ajay', lastname='Verma')
...
def generate_full_name (first_name = 'Ajay', last_name = 'Verma'):
    space = ' '
    full_name = first_name + space + last_name
    return full_name
...
def generate_groups (team,*args):
    ...
    for i in args:
        print(i)
print(generate_groups('Team-1','Ajay','Brook','David','Eyob'))
