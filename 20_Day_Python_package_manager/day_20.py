...
karma@Ajay:~ $ pip install pip

# Check if pip is installed by writing
pip --version

karma@Ajay:~$ pip --version
...
# Let us check some of the packages used in the Python community for different purposes. 
# Just to let you know that there are lots of packages available for use with different applications.
...
# This section is not about numpy nor pandas, here we are trying to learn how to install packages and how to import them. 
# If it is needed, we will talk about different packages in other sections.
...
# For instance if you like to open any number of websites at any time or if you like to schedule something, this _webbrowser_ module can be used.
...
url_lists = [
    'http://www.python.org',
    'https://www.linkedin.com/in/ajayv03/',
]
...
karma@Ajay:~$ pip show --verbose pandas
Name: pandas
Version: 1.2.3
Summary: Powerful data structures for data analysis, time series, and statistics
Home-page: http://pandas.pydata.org
...
# To open a network connection, we need a package called _requests_ - it allows to open a network connection and to implement CRUD(create, read, update and delete) operations. 
# In this section, we will cover only reading ore getting part of a CRUD.

### Let us install _requests_:

karma@Ajay:~$ pip install requests
...
# As you know, a module can contain multiple objects, such as classes, functions, etc. A package can contain one or more relevant modules. 
# A package is actually a folder containing one or more module files. Let us create a package named mypackage, using the following steps:
...
karma@Ajay:~/Desktop/30DaysOfPython$ python
Python 3.9.6 (default, Jun 28 2021, 15:26:21)
[Clang 11.0.0 (clang-1100.0.33.8)] on darwin
Type "help", "copyright", "credits" or "license" for more information.
...
>>> greet.greet_person('Ajay', 'Verma')
'Ajay Verma, welcome to 30DaysOfPython Challenge!'
>>>
