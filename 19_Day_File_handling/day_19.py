...
In Python to handle data we use _open()_ built-in function.
'''
# Syntax
...
# Opened file has different reading methods: _read()_, _readline_, _readlines_. An opened file has to be closed with _close()_ method.
...
# There is a new way of opening files using _with_ - closes the files by itself. 
# Let us rewrite the the previous example with the _with_ method:
...
### Deleting Files
# We have seen in previous section, how to make and remove a directory using _os_ module. 
# Again now, if we want to remove a file we use _os_ module.
...
person_json = "{'name': 'Ajay', 'country': 'India', 'city': 'Hisar', 'skills': ['JavaScrip', 'React', 'Python']}"
...
# output
# <class 'dict'>
# {'name': 'Ajay', 'country': 'India', 'city': 'Hisar', 'skills': ['JavaScrip', 'React', 'Python']}
# Ajay
...
#         Ajay is a teacher. He lives in India, Hisar.
# Number of lines:  2
