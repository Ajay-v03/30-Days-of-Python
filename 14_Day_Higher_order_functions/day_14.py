...
print_full_name("Ajay", "Verma",'India')
...
names = ['Ajay', 'Ashish', 'Abhishek', 'Rohit']  # iterable

def change_to_upper(name):
    return name.upper()

names_upper_cased = map(change_to_upper, names)
print(list(names_upper_cased))    # ['AJAY', 'ASHISH', 'ABHISHEK', 'ROHIT']
...
'''The _reduce()_ function is defined in the functools module and we should import it from this module. 
