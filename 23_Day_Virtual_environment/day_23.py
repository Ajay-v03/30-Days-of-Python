...
karma@Ajay:~$ pip install virtualenv
...
For Mac/Linux:
karma@Ajay:~/Desktop/30DaysOfPython/flask_project\$ virtualenv venv
...
karma@Ajay:~/Desktop/30DaysOfPython/flask_project$ ls
venv/

Let us activate the virtual environment by writing the following command at our project folder.

For Mac/Linux:
karma@Ajay:~/Desktop/30DaysOfPython/flask_project$ source venv/bin/activate
...
(venv) karma@Ajay:~/Desktop/30DaysOfPython/flask_project$
...
(venv) karma@Ajay:~/Desktop/30DaysOfPython/flask_project$ pip install Flask

Now, let us write pip freeze to see a list of installed packages in the project:

(venv) karma@Ajay:~/Desktop/30DaysOfPython/flask_project$ pip freeze
Click==7.0
Flask==1.1.1
itsdangerous==1.1.0
Jinja2==2.10.3
...
(venv) karma@Ajay:~/Desktop/30DaysOfPython$ deactivate
